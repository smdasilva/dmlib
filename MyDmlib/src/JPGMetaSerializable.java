...
public class JPGMetaSerializable implements Serializable {
    ...
    public String SubsecondTime;       
    public String SubsecondTimeDig;
    public String SubsecondTimeOrigin;       
    public String WhiteBalance;
    public String FlashComp;
    public String LendId;       
    public String LensSerialNumb;       
            
    public JPGMetaSerializable(String aperture, String title,  String DateTaken, String LensModel, String  ColorSpace,      
                                String CustomRendered, String DateTimeDigitized, String  DateTimeOriginal, String  ExifVersion,      
    String ExposureBiasValue, String ExposureMode, String ExposureTime, String ExposureProgram,       
    String Flash, String FlashPixVersion, String FNumber, String FocalLength, String FocalPlanResolutionUnit, String  FocalPlanXResolution,     
    String FocalPlanYResolution, String IsoSpeddRatings, String MeteringMode, String SceneCaptureType,
    String ShutterSpeedValue, String SubsecondTime, String SubsecondTimeDig, String SubsecondTimeOrigin, String WhiteBalance, String FlashComp,
    String LendId, String LensSerialNumb)
    {
        ...
        this.SubsecondTime = SubsecondTime;
        this.SubsecondTimeDig = SubsecondTimeDig;
        this.SubsecondTimeOrigin = SubsecondTimeOrigin;
        this.WhiteBalance = WhiteBalance;
        this.FlashComp = FlashComp;
        this.LendId = LendId;
        this.LensSerialNumb = LensSerialNumb;              
    }
    ...
    /**
     * @return the SubsecondTimeDig
     */
    public String getSubsecondTimeDig() {
        return SubsecondTimeDig;
    }

    /**
     * @return the SubsecondTimeOrigin
     */
    public String getSubsecondTimeOrigin() {
        return SubsecondTimeOrigin;
    }
    ...
    /**
     * @return the LensSerialNumb
     */
    public String getLensSerialNumb() {
        return LensSerialNumb;
    }
}
